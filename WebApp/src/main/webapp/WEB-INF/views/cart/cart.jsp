...
<%@ taglib uri=                                                    <c:when test="${not empty item.imageUrl}">
                                                        <img src="${item.imageUrl}" 
                                                             class="img-fluid rounded food-image" 
                                                             alt="${item.menuItemName}">p://java.sun.com/jsp/jstl/core" prefix="c" %>
                        ...
                        <div class="card cart-summary text-white">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span>₹<fmt:formatNumber value="${cart.subtotal * 0.05}" pattern="#,##0.00"/></span>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <strong>₹<fmt:formatNumber value="${cart.totalAmount + 40 + (cart.subtotal * 0.05)}" pattern="#,##0.00"/></strong>
                                </div>
                                ...
                                <!-- Checkout Button -->
                                <div class="d-grid">
                                    <a href="/swiggaa/cart/checkout" class="btn btn-checkout btn-lg">
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center empty-cart d-flex flex-column justify-content-center align-items-center">
                            ...
                            <a href="${pageContext.request.contextPath}/menu" class="btn btn-primary btn-lg">
